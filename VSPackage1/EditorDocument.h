...
[$RootKey$\KeyBindingTables\{8a742be5-83ae-48a4-b6b1-76bf1793793a}]
@="#1"
...
VSPackage1UI.vsct, to work correctly so that the appropriate command handler below will be
called.
...
class EditorDocument : 
	...
	public IDispatchImpl<ISingleViewEditor, &__uuidof(ISingleViewEditor), &LIBID_VSPackage1Lib>,
...
VSL_BEGIN_COMMAND_MAP()
	...
	VSL_COMMAND_MAP_ENTRY(CLSID_VSPackage1CmdSet, commandIDStrike, &OnQueryStrikeOut, &OnStrikeOut)
...
// Data members
	...
	VsMacroRecorder<&CLSID_VSPackage1EditorDocument, LastMacro, eLastMacroNone> m_Recorder;
